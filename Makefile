...
all:
	gcc $(CFLAGS) -o lgcc src/main.c src/lexer.c src/token.c src/parse_args.c src/file_io.c src/linked_list.c src/parser.c
...
test-parser:
	gcc $(CFLAGS) $(TESTFLAGS) -o test_parser tests/parser_test.c src/parser.c src/token.c src/linked_list.c $(UNITY_SRC)/unity.c -I./src -I$(UNITY_SRC)
